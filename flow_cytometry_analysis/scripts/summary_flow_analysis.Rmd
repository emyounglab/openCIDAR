...
Make separate dataframe for positive values of MEFL only (negative values result from conversion of voltage -> AU -> MEFL). This will be used for geomeric mean and log calculations
...
Import original CIDAR study values to compare to openCIDAR constructs. These were extraploated from the original CIDAR paper (Iverson et al. 2016) supplemental figure 1
...
# Linear models
Set the empty vector as the reference level
